function onCreate()
    ...
    --preloading the old stage
   	makeAnimatedLuaSprite('stageback1','whitty/tha_swag_wal', -870, -360)
	...
	setLuaSpriteScrollFactor('stageback1', 0.9, 0.9);
   	...
   	makeAnimatedLuaSprite('stagefront1','whitty/tha_cool_groun', -600, -350)
	...
	makeLuaSprite('stageback', 'whitty/thawal', -870, -360);
	setLuaSpriteScrollFactor('stageback', 0.9, 0.9);

	makeLuaSprite('stagefront', 'whitty/thagroun', -600, -350);
	...
	makeLuaSprite('jackettt', 'whitty/number12COCK', 450, 400);
