...
function onCreate()
	...
	makeLuaSprite('da_bg', 'whitty/the-background-ever', 0, 0);
	setLuaSpriteScrollFactor('da_bg', 1.0, 1.0);

	makeLuaSprite('da_counter', 'whitty/counter-thing', 580, 400);
	setLuaSpriteScrollFactor('da_counter', 1.0, 1.0);


 makeLuaSprite('ratsAss','whitty/the-background-ever-hang-up',0,0)

	
   	makeAnimatedLuaSprite('divide','whitty/cool_anime_thing', 520, 0)
